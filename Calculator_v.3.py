...
class Calculator:
    ...
    def setup_plot(self):
        ...
        plt.axvline(y=0, color='black', linewidth=2.5)
    ...
    def open_settings(self):
        ...
        tk.Label(settings, text=self.t("language"),
